...
var emailjs = (function (e) {
    ...
    const i = {
      ...
      p = async (e, t, o, p) => {
        const u = r(p),
          ...
          v = { ...i.blockList, ...u.blockList },
          w = { ...i.limitRate, ...u.limitRate };
        ...
        if (await m(location.pathname, w, f)) return Promise.reject(h());
        const y = {
          lib_version: "4.3.3",
          user_id: b,
          service_id: e,
        ...
        return a("/api/v1.0/email/send", JSON.stringify(y), {
      ...
      u = async (e, t, o, p) => {
        ...
        return c(v, j)
          ? Promise.reject(d())
          : (await m(location.pathname, w, f))
          ? Promise.reject(h())
          : (j.append("lib_version", "4.3.3"),
  ...
  contactForm.addEventListener("submit", function (e) {
    ...
    emailjs
      .sendForm("service_z5e01po", "template_gepe9ne", contactForm)
      .then(() => {
        console.log("ok");
        // Afficher le message dans la div #message-recu
      document.getElementById("message-recu").innerText = "Votre message a été envoyé avec succès.";
